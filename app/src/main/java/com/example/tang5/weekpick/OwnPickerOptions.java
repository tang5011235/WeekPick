...
public class OwnPickerOptions {
    ...
    public OwnOnOptionsSelectListener optionsSelectListener;
    public OnTimeSelectListener timeSelectListener;

    public OnTimeSelectChangeListener timeSelectChangeListener;
    public OwnOnOptionsSelectChangeListener optionsSelectChangeListener;
    ...
    public OwnPickerOptions(int buildType) {
